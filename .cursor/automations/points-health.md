...
1. Fetch: https://huzaifahp1989-audio.vercel.app/api/health/points
   ...
   - Also note: https://islamic-kids-platform.vercel.app is a stale host; middleware should 307 to huzaifahp1989-audio.vercel.app. If Cap/LIVE_APP_URL still points at a deploy with placeholder.supabase.co, treat as critical and restore LIVE_APP_URL to https://huzaifahp1989-audio.vercel.app (with real Supabase env on that Vercel project).
...
- supabase_url_missing → NEXT_PUBLIC_SUPABASE_URL must be the real project URL (jlqrbbqsuksncrxjcmbc.supabase.co). Canonical Cap/live host: https://huzaifahp1989-audio.vercel.app (keep src/lib/app-url.ts + capacitor.config.ts in sync).
