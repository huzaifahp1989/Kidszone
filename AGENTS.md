...
4. **Tests before done:** Run `npm test -- src/lib/points-policy.test.ts src/lib/points-health.test.ts`. Both must pass. Do not weaken assertions to hide real regressions.
