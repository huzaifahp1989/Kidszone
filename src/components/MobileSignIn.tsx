          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-gray-300 px-3 py-2 pr-16 focus:outline-none focus:ring-2 focus:ring-islamic-blue focus:border-transparent transition-all"
                value={password}
