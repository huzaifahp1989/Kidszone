      ...
      <div className="min-h-screen bg-[#f0fdfa] pattern-islamic">
        <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#f0fdfa] rounded-full border border-[#0d9488]/20">
              <Sparkles size={16} className="text-[#0d9488]" />
              <span className="text-sm font-semibold text-[#0f766e]">Daily Challenge</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-[#134e4a]">
              Today's Quiz
            </h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-[#5eead4]/30 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  {countdown && (
                    <div className="flex items-center gap-2 text-[#475569] text-sm font-semibold">
                      ...
                      Next quiz available in <span className="text-[#134e4a] font-bold ml-1">{countdown}</span>
                    </div>
                  )}
                  <div className="bg-[#fffbeb] rounded-xl p-4 border border-[#fbbf24]/30 text-left">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Link href="/games" className="inline-flex items-center gap-2 bg-[#0d9488] text-white px-4 py-2 rounded-lg font-bold text-sm hover:bg-[#0f766e] transition-all">
                        🎮 Play Games
                      </Link>
                      ...
                      <Link href="/guide" className="inline-flex items-center gap-2 bg-white text-[#0f766e] px-4 py-2 rounded-lg font-bold text-sm ring-1 ring-violet-200 hover:bg-violet-50 transition-all">
                        ⭐ Points guide
                      </Link>
                    </div>
                  </div>
              ...
              {isLoadingTopicQuiz && (
                <div className="rounded-xl border border-[#5eead4]/40 bg-[#f0fdfa] px-4 py-3 text-sm font-semibold text-[#0f766e]">
              ...
              {/* Description */}
              <div className="space-y-3 text-[#134e4a]">
                <p className="text-lg">
              ...
              <div className="space-y-6">
                {QUIZ_TOPIC_GROUPS.map((group) => {
                  ...
                  return (
                    <div key={group.id}>
                      <h3 className="mb-3 text-sm font-bold uppercase tracking-wide text-[#0f766e]">
                        {group.title}
                      </h3>
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-xl border p-4 text-left transition-all ${
                                isReady
                                  ? 'bg-white border-[#0d9488]/30 hover:border-[#0d9488] hover:shadow-md'
                                  : 'bg-gray-100 border-gray-200 text-gray-400 cursor-not-allowed'
                              }`}
                            >
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-2xl">{topic.emoji}</span>
                                <span className="text-xs font-bold px-2 py-1 rounded-full bg-[#f0fdfa] text-[#0f766e]">
                                  +{QUIZ_POINTS_PER_COMPLETION} pts
                                </span>
                              </div>
                              <p className="font-bold text-[#134e4a]">{topic.label}</p>
              ...
              {!user?.id && dailyStatus === 'ready' && (
                <Link
                  ...
                  className="block py-4 px-6 rounded-xl font-bold text-lg bg-white text-[#0d9488] border-2 border-[#0d9488] hover:bg-[#f0fdfa] transition-all text-center"
                >
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={idx} className="bg-white rounded-xl p-4 text-center border border-[#5eead4]/20 shadow-sm">
                <span className="text-2xl">{stat.icon}</span>
                <p className="text-2xl font-bold text-[#134e4a] mt-1">{stat.value}</p>
    ...
    <div className="min-h-screen bg-[#f0fdfa] py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <button
            onClick={resetPage}
            className="flex items-center gap-2 text-[#134e4a] hover:text-[#0d9488] font-semibold transition"
          >
            <ArrowLeft size={20} />
            Exit
          </button>
        ...
        {!quizComplete ? (
          <div className="bg-white rounded-2xl shadow-lg border border-[#5eead4]/30 p-6 sm:p-8">
            {/* Progress Bar */}
            <div className="w-full bg-[#ccfbf1] h-3 rounded-full mb-8 overflow-hidden">
              <div
                className="bg-gradient-to-r from-[#0d9488] to-[#fbbf24] h-full rounded-full transition-all duration-500"
            ...
            <div className="mb-4 flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center rounded-full bg-[#f0fdfa] text-[#0f766e] border border-[#0d9488]/30 px-3 py-1 text-xs font-bold uppercase tracking-wide">
            ...
            {currentQuestion?.story ? (
              <div className="mb-6 rounded-xl border border-[#5eead4]/40 bg-[#faf5ff] p-4">
                <p className="text-xs font-bold uppercase tracking-wide text-[#0d9488] mb-2">Story</p>
                <p className="text-[#134e4a] leading-relaxed">{currentQuestion.story}</p>
              </div>
            ) : null}

            <div className="mb-6 flex items-start justify-between gap-3">
              <h2 className="text-xl sm:text-2xl font-bold text-[#134e4a] leading-relaxed">
                      ...
                      isCorrect
                        ...
                        : isWrong
                          ...
                          : isSelected
                            ...
                            : 'border-[#5eead4]/50 bg-white text-[#134e4a] hover:border-[#0d9488]/50 hover:bg-[#ccfbf1]'
            ...
            {showFeedback ? (
              <div className="mt-6 rounded-xl border border-[#0d9488]/20 bg-[#faf5ff] p-5 space-y-3 text-left">
                ...
                {currentQuestion?.explanation ? (
                  <p className="text-[#134e4a] leading-relaxed">{currentQuestion.explanation}</p>
                ) : null}
            ...
            {/* Next Button */}
            <div className="mt-8 pt-6 border-t border-[#5eead4]/30">
              <button
                onClick={handleNext}
                disabled={selectedAnswer === null}
                className={`w-full py-4 rounded-xl font-bold text-lg transition-all ${
                  selectedAnswer !== null
                    ? 'bg-gradient-to-r from-[#0d9488] to-[#0f766e] text-white shadow-lg hover:shadow-xl'
          ...
          // Quiz Complete View
          <div className="bg-white rounded-2xl shadow-lg border border-[#5eead4]/30 p-8 text-center">
            {isSubmitting ? (
              <div className="py-12">
                <div className="animate-spin text-4xl mb-4">🔄</div>
                <p className="text-[#134e4a]">Submitting your answers...</p>
              </div>
            ) : (
              <>
                ...
                <h2 className="text-3xl font-bold text-[#134e4a] mb-2">Quiz Completed!</h2>
                <p className="text-[#475569] mb-6">MashaAllah! You finished the daily quiz.</p>

                <div className="space-y-4 mb-8">
                  <div className="bg-[#f0fdfa] rounded-xl p-4">
                    <p className="text-sm text-[#0f766e] font-semibold uppercase tracking-wide">Your Score</p>
                    <p className="text-4xl font-bold text-[#0d9488]">{dailyResult?.score} / {currentQuestions.length}</p>
                  </div>
                  ...
                  {dailyResult?.awardedPoints > 0 ? (
                    <p className="text-[#0d9488] font-bold text-lg">+{dailyResult.awardedPoints} Points Added to Leaderboard! ⭐</p>
                  ) : (
                    <p className="text-[#475569]">{dailyResult?.message || 'No points awarded for this attempt.'}</p>
                  )}

                  <div className="bg-[#f0fdfa] rounded-xl p-4 border border-[#0d9488]/20 text-left">
                    <p className="font-bold text-[#0f766e] mb-1">New games added! 🎮</p>
                    <p className="text-[#115e59] text-sm mb-3">
                      Want to gain more points? Check out the Games page and try the newest games.
                    </p>
                    <Link href="/games" className="inline-flex items-center gap-2 bg-[#0d9488] text-white px-4 py-2 rounded-lg font-bold text-sm hover:opacity-95 transition-all">
                      Play Games →
                    </Link>
                  </div>
                  ...
                  <div className="bg-[#fffbeb] rounded-xl p-4 border border-[#fbbf24]/30 text-left">
                    ...
                    {countdown && (
                      <p className="flex items-center gap-1.5 text-xs text-[#475569] font-semibold mb-3">
                        <Clock size={13} /> Next quiz in <span className="text-[#134e4a] font-bold ml-1">{countdown}</span>
                      </p>
                    )}
                    <Link href="/pledge" className="inline-flex items-center gap-2 bg-[#fbbf24] text-[#92400e] px-4 py-2 rounded-lg font-bold text-sm hover:bg-[#f59e0b] transition-all">
                      📿 Pledge Durood &amp; Zikr →
                ...
                <button
                  onClick={resetPage}
                  className="w-full py-4 bg-gradient-to-r from-[#0d9488] to-[#0f766e] text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all"
                >
                  Return to Quiz Menu
                </button>
              </>
