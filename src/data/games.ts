...
export const trueOrFalsePool: BaseTask[] = [
  ...
  {
    id: 'tf-11',
    prompt: 'Muslims pray five times a day.',
    points: 2,
    options: [{ id: 'tf11-t', text: 'True' }, { id: 'tf11-f', text: 'False' }],
    correctOptionId: 'tf11-t',
  },
  {
    id: 'tf-12',
    prompt: 'Zamzam water is found in Madinah.',
    points: 2,
    options: [{ id: 'tf12-t', text: 'True' }, { id: 'tf12-f', text: 'False' }],
    correctOptionId: 'tf12-f',
  },
  {
    id: 'tf-13',
    prompt: 'The Quran has 114 surahs.',
    points: 2,
    options: [{ id: 'tf13-t', text: 'True' }, { id: 'tf13-f', text: 'False' }],
    correctOptionId: 'tf13-t',
  },
  {
    id: 'tf-14',
    prompt: 'Prophet Muhammad ﷺ was born in Madinah.',
    points: 2,
    options: [{ id: 'tf14-t', text: 'True' }, { id: 'tf14-f', text: 'False' }],
    correctOptionId: 'tf14-f',
  },
  {
    id: 'tf-15',
    prompt: 'Fasting during Ramadan is one of the Five Pillars of Islam.',
    points: 2,
    options: [{ id: 'tf15-t', text: 'True' }, { id: 'tf15-f', text: 'False' }],
    correctOptionId: 'tf15-t',
  },
  {
    id: 'tf-16',
    prompt: 'Prophet Yusuf ﷺ was thrown into a well by his brothers.',
    points: 2,
    options: [{ id: 'tf16-t', text: 'True' }, { id: 'tf16-f', text: 'False' }],
    correctOptionId: 'tf16-t',
  },
  {
    id: 'tf-17',
    prompt: 'The angels are made from fire.',
    points: 2,
    options: [{ id: 'tf17-t', text: 'True' }, { id: 'tf17-f', text: 'False' }],
    correctOptionId: 'tf17-f',
  },
  {
    id: 'tf-18',
    prompt: 'Surah Al-Fatiha is recited in every unit of prayer.',
    points: 2,
    options: [{ id: 'tf18-t', text: 'True' }, { id: 'tf18-f', text: 'False' }],
    correctOptionId: 'tf18-t',
  },
  {
    id: 'tf-19',
    prompt: 'Prophet Dawud ﷺ was given the Injeel (Gospel).',
    points: 2,
    options: [{ id: 'tf19-t', text: 'True' }, { id: 'tf19-f', text: 'False' }],
    correctOptionId: 'tf19-f',
  },
  {
    id: 'tf-20',
    prompt: 'Tawaf means circling the Kaaba seven times.',
    points: 2,
    options: [{ id: 'tf20-t', text: 'True' }, { id: 'tf20-f', text: 'False' }],
    correctOptionId: 'tf20-t',
  },
  {
    id: 'tf-21',
    prompt: 'The Quran was first written down entirely during the time of the Prophet ﷺ.',
    points: 2,
    options: [{ id: 'tf21-t', text: 'True' }, { id: 'tf21-f', text: 'False' }],
    correctOptionId: 'tf21-f',
  },
  {
    id: 'tf-22',
    prompt: 'Jibril (Gabriel) ﷺ brought the revelation of the Quran to the Prophet ﷺ.',
    points: 2,
    options: [{ id: 'tf22-t', text: 'True' }, { id: 'tf22-f', text: 'False' }],
    correctOptionId: 'tf22-t',
  },
  {
    id: 'tf-23',
    prompt: 'Eid al-Adha celebrates the end of Ramadan.',
    points: 2,
    options: [{ id: 'tf23-t', text: 'True' }, { id: 'tf23-f', text: 'False' }],
    correctOptionId: 'tf23-f',
  },
  {
    id: 'tf-24',
    prompt: 'The Night Journey (Isra wal Miraj) is when the Prophet ﷺ travelled to Jerusalem and the heavens.',
    points: 2,
    options: [{ id: 'tf24-t', text: 'True' }, { id: 'tf24-f', text: 'False' }],
    correctOptionId: 'tf24-t',
  },
  {
    id: 'tf-25',
    prompt: 'There are 99 names of Allah.',
    points: 2,
    options: [{ id: 'tf25-t', text: 'True' }, { id: 'tf25-f', text: 'False' }],
    correctOptionId: 'tf25-t',
  },
];
...
export const namesOfAllahPool: BaseTask[] = [
  ...
  {
    id: 'na-11',
    prompt: 'What does "Al-Qadir" mean?',
    points: 2,
    options: [
      { id: 'na11-a', text: 'The All-Powerful / The Able' },
      { id: 'na11-b', text: 'The Most Merciful' },
      { id: 'na11-c', text: 'The Eternal' },
      { id: 'na11-d', text: 'The Generous' },
    ],
    correctOptionId: 'na11-a',
  },
  {
    id: 'na-12',
    prompt: 'Which name means "The Eternal / The Everlasting"?',
    points: 2,
    options: [
      { id: 'na12-a', text: 'Al-Hayy' },
      { id: 'na12-b', text: 'Al-Baqi' },
      { id: 'na12-c', text: 'Al-Awwal' },
      { id: 'na12-d', text: 'Al-Akhir' },
    ],
    correctOptionId: 'na12-b',
  },
  {
    id: 'na-13',
    prompt: 'What does "Al-Karim" mean?',
    points: 2,
    options: [
      { id: 'na13-a', text: 'The Most Generous / The Noble' },
      { id: 'na13-b', text: 'The Most Merciful' },
      { id: 'na13-c', text: 'The All-Knowing' },
      { id: 'na13-d', text: 'The Most Powerful' },
    ],
    correctOptionId: 'na13-a',
  },
  {
    id: 'na-14',
    prompt: 'Which name of Allah means "The Most High / The Supreme"?',
    points: 2,
    options: [
      { id: 'na14-a', text: 'Al-Aziz' },
      { id: 'na14-b', text: 'Al-Aliy' },
      { id: 'na14-c', text: 'Al-Kabir' },
      { id: 'na14-d', text: 'Al-Muta\'ali' },
    ],
    correctOptionId: 'na14-b',
  },
  {
    id: 'na-15',
    prompt: 'What does "Ar-Rahim" mean?',
    points: 2,
    options: [
      { id: 'na15-a', text: 'The Most Merciful (special mercy for believers)' },
      { id: 'na15-b', text: 'The Most Generous' },
      { id: 'na15-c', text: 'The Creator' },
      { id: 'na15-d', text: 'The Judge' },
    ],
    correctOptionId: 'na15-a',
  },
  {
    id: 'na-16',
    prompt: 'Which name means "The King / The Sovereign"?',
    points: 2,
    options: [
      { id: 'na16-a', text: 'Al-Jabbar' },
      { id: 'na16-b', text: 'Al-Aziz' },
      { id: 'na16-c', text: 'Al-Malik' },
      { id: 'na16-d', text: 'Al-Qayyum' },
    ],
    correctOptionId: 'na16-c',
  },
  {
    id: 'na-17',
    prompt: 'What does "Al-Tawwab" mean?',
    points: 2,
    options: [
      { id: 'na17-a', text: 'The Acceptor of Repentance' },
      { id: 'na17-b', text: 'The All-Knowing' },
      { id: 'na17-c', text: 'The Creator' },
      { id: 'na17-d', text: 'The Sustainer' },
    ],
    correctOptionId: 'na17-a',
  },
  {
    id: 'na-18',
    prompt: 'Which name of Allah means "The Light"?',
    points: 2,
    options: [
      { id: 'na18-a', text: 'Al-Haqq' },
      { id: 'na18-b', text: 'An-Nur' },
      { id: 'na18-c', text: 'Al-Wali' },
      { id: 'na18-d', text: 'Al-Mubin' },
    ],
    correctOptionId: 'na18-b',
  },
  {
    id: 'na-19',
    prompt: 'What does "Al-Afuw" mean?',
    points: 2,
    options: [
      { id: 'na19-a', text: 'The Pardoner / The Eraser of sins' },
      { id: 'na19-b', text: 'The Just' },
      { id: 'na19-c', text: 'The Grateful' },
      { id: 'na19-d', text: 'The Patient' },
    ],
    correctOptionId: 'na19-a',
  },
  {
    id: 'na-20',
    prompt: 'Which name means "The Ever-Living"?',
    points: 2,
    options: [
      { id: 'na20-a', text: 'Al-Baqi' },
      { id: 'na20-b', text: 'Al-Qayyum' },
      { id: 'na20-c', text: 'Al-Hayy' },
      { id: 'na20-d', text: 'Al-Awwal' },
    ],
    correctOptionId: 'na20-c',
  },
  {
    id: 'na-21',
    prompt: 'What does "Al-Quddus" mean?',
    points: 2,
    options: [
      { id: 'na21-a', text: 'The Holy / The Pure' },
      { id: 'na21-b', text: 'The Almighty' },
      { id: 'na21-c', text: 'The First' },
      { id: 'na21-d', text: 'The Last' },
    ],
    correctOptionId: 'na21-a',
  },
  {
    id: 'na-22',
    prompt: 'Which name of Allah means "The Protector / The Guardian"?',
    points: 2,
    options: [
      { id: 'na22-a', text: 'Al-Wakil' },
      { id: 'na22-b', text: 'Al-Hafiz' },
      { id: 'na22-c', text: 'Al-Wali' },
      { id: 'na22-d', text: 'Al-Muqit' },
    ],
    correctOptionId: 'na22-b',
  },
  {
    id: 'na-23',
    prompt: 'What does "Al-Aziz" mean?',
    points: 2,
    options: [
      { id: 'na23-a', text: 'The Most Powerful / The Almighty' },
      { id: 'na23-b', text: 'The Most Gracious' },
      { id: 'na23-c', text: 'The Patient' },
      { id: 'na23-d', text: 'The Forgiving' },
    ],
    correctOptionId: 'na23-a',
  },
  {
    id: 'na-24',
    prompt: 'Which name means "The First" (nothing existed before Him)?',
    points: 2,
    options: [
      { id: 'na24-a', text: 'Al-Akhir' },
      { id: 'na24-b', text: 'Al-Zahir' },
      { id: 'na24-c', text: 'Al-Awwal' },
      { id: 'na24-d', text: 'Al-Batin' },
    ],
    correctOptionId: 'na24-c',
  },
];
