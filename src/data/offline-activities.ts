...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 220" width="320" height="220">
  <rect x="0" y="0" width="320" height="220" rx="16" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <circle cx="130" cy="110" r="55" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <circle cx="155" cy="100" r="42" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <path d="M230 70 L238 92 L262 92 L242 106 L250 128 L230 114 L210 128 L218 106 L198 92 L222 92 Z" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 220" width="320" height="220">
  <rect x="0" y="0" width="320" height="220" rx="16" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="152" y="18" width="16" height="18" rx="4" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="120" y="36" width="80" height="22" rx="6" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="110" y="58" width="100" height="110" rx="14" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="128" y="78" width="64" height="70" rx="10" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="118" y="170" width="84" height="18" rx="6" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 220" width="320" height="220">
  <rect x="0" y="0" width="320" height="220" rx="16" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="0" y="175" width="320" height="45" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <ellipse cx="150" cy="95" rx="70" ry="45" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="80" y="95" width="140" height="80" rx="8" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="130" y="125" width="40" height="50" rx="8" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <rect x="235" y="55" width="28" height="120" rx="6" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
  <ellipse cx="249" cy="52" rx="20" ry="14" fill="#ffffff" stroke="#1e1b4b" stroke-width="2"/>
...
export function buildDotToDotSvg(): string {
  const dots = DOT_TO_DOT_POINTS.map(
    (d) =>
      `<g>
  <circle cx="${d.x}" cy="${d.y}" r="8" fill="#ffffff" stroke="#1e1b4b" stroke-width="1.5"/>
  <text x="${d.x}" y="${d.y + 3.5}" text-anchor="middle" font-family="sans-serif" font-size="8" font-weight="bold" fill="#1e1b4b">${d.n}</text>
</g>`
  ).join('\n');
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 280" width="720" height="560">
  ...
  <rect x="20" y="20" width="320" height="220" fill="none" stroke="#1e1b4b" stroke-width="4"/>
  <path d="M20 60 H120 V100 H60 V140 H140 V60 H200 V180 H100 V220
           ...
           M60 180 H100" fill="none" stroke="#1e1b4b" stroke-width="4" stroke-linecap="square"/>
  ...
  <rect x="290" y="190" width="40" height="40" rx="6" fill="#ffffff" stroke="#7c3aed" stroke-width="3"/>
